                ...
                <div class="space-y-5">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600"><?php echo e(\App\Models\Setting::get('sekolah_alamat', 'Jl. Raya Krasak No. 45 Desa Krasak, Kec. Bangsri Kabupaten Jepara, Jawa Tengah 59453')); ?></p>
                        </div>
                    </div>
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600"><?php echo e(\App\Models\Setting::get('sekolah_telepon', '(0291) 771380')); ?></p>
                        </div>
                    </div>
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600"><?php echo e(\App\Models\Setting::get('sekolah_email', 'sdn3krasakbangsri@gmail.com')); ?></p>
                        </div>
                    </div>
                </div>
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600"><?php echo e(\App\Models\Setting::get('kode_pos', '-')); ?></p>
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                ...
                <?php $__currentLoopData = $fasilitas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="card-hover bg-white rounded-xl p-6 border border-gray-100 text-center hover:shadow-xl">
                        <div class="w-14 h-14 bg-<?php echo e($f['color']); ?>-100 rounded-xl flex items-center justify-center mx-auto mb-4">
                            <i class="bi <?php echo e($f['icon']); ?> text-<?php echo e($f['color']); ?>-600 text-2xl"></i>
                        </div>
                        <h4 class="font-bold text-gray-800 text-sm"><?php echo e($f['nama']); ?></h4>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
                ...
                <?php if(count($prestasi) > 0): ?>
                    <?php $__currentLoopData = $prestasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-start gap-4 bg-gradient-to-r from-yellow-50 to-white border border-yellow-100 rounded-xl p-5">
                            ...
                            <p class="text-gray-700 mt-1"><?php echo e(trim($item)); ?></p>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php else: ?>
