    ...
    <section class="py-12 bg-white">
        <div class="max-w-5xl mx-auto px-6 sm:px-8 lg:px-10">
            ...
            <div class="bg-gradient-to-br from-blue-700 to-blue-900 rounded-xl p-10 text-white text-center max-w-2xl mx-auto mb-12 shadow-lg">
                ...
                <a href="<?php echo e(\App\Models\Setting::get('sekolah_instagram', 'https://www.instagram.com/sdn3krasakbangsri')); ?>" target="_blank" class="inline-flex items-center gap-2 bg-white/20 hover:bg-white/30 text-white font-bold px-8 py-3 rounded-lg transition-colors duration-300 shadow-md hover:shadow-lg">
