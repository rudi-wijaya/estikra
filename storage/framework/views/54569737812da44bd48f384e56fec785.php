...
<div class="container-fluid">
    <div class="row mb-4">
        ...
        <div class="col-md-4 text-end">
            <a href="<?php echo e(route('admin.beritas.index')); ?>" class="btn btn-primary">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="url" class="form-control <?php $__errorArgs = ['link_eksternal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                           ...
                           value="<?php echo e(old('link_eksternal', $berita->link_eksternal ?? '')); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="1" id="tambah_ke_prestasi" name="tambah_ke_prestasi" <?php echo e($checkboxPrestasi ? 'checked' : ''); ?>>
                        <label class="form-check-label" for="tambah_ke_prestasi">
                            Ini termasuk berita Prestasi
                        </label>
                    </div>
                    <?php if($sudahTerhubungKePrestasi): ?>
