    ...
    <div class="admin-wrapper">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="<?php echo e(route('admin.settings.index')); ?>" class="<?php echo e(request()->routeIs('admin.settings.index') || request()->routeIs('admin.settings.update') ? 'active' : ''); ?>">
                        <i class="bi bi-gear"></i>
                        <span>Profil</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('admin.settings.tentang.index')); ?>" class="<?php echo e(request()->routeIs('admin.settings.tentang.*') ? 'active' : ''); ?>">
                ...
                <li>
                    <a href="<?php echo e(route('admin.ppdb.index')); ?>" class="<?php echo e(request()->routeIs('admin.ppdb.*') ? 'active' : ''); ?>">
                ...
                <div class="navbar-right">
                    <div class="dropdown navbar-item" title="Notifikasi">
                        <button class="navbar-icon-btn dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false" aria-label="Notifikasi">
                            ...
                            <?php if($notifTotal > 0): ?>
                                <span class="notif-badge"><?php echo e($notifTotal > 99 ? '99+' : $notifTotal); ?></span>
                            <?php endif; ?>
                        </button>
                        <ul class="dropdown-menu dropdown-menu-end notif-menu">
                            <li class="dropdown-header">Notifikasi Sistem</li>
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('admin.beritas.index')); ?>">
                                    Draft Berita
                                    <small><?php echo e($notifDraftBerita); ?> item belum dipublikasikan</small>
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('admin.users.index')); ?>">
                                    User Tidak Aktif
                                    <small><?php echo e($notifInactiveUsers); ?> akun perlu ditinjau</small>
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('admin.ppdb.index')); ?>">
                                    Item PPDB Nonaktif
                                    <small><?php echo e($notifInactivePpdb); ?> item belum aktif</small>
                                </a>
                            </li>
                        </ul>
                    </div>
                    <div class="user-profile">
                        ...
                        <div class="user-name d-none d-md-block"><?php echo e(auth()->user()->name); ?></div>
                    </div>
                </div>
            </nav>
