...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row dashboard-grid-gap mb-2">
        ...
        <div class="col-6 col-sm-6 col-lg-3 dashboard-stat-col">
            <div class="stat-card">
                <div class="stat-value"><?php echo e($publishedBeritas); ?></div>
        ...
        <div class="col-6 col-sm-6 col-lg-3 dashboard-stat-col">
            <div class="stat-card">
                <div class="stat-value"><?php echo e($totalGaleris); ?></div>
            ...
            <div class="card h-100">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <a href="<?php echo e(route('admin.beritas.create')); ?>" class="quick-action">
                        ...
                        <a href="<?php echo e(route('admin.galeris.create')); ?>" class="quick-action">
                        ...
                        <a href="<?php echo e(route('admin.guru-staffs.create')); ?>" class="quick-action">
                        ...
                        <a href="<?php echo e(route('admin.users.create')); ?>" class="quick-action">
                ...
                <div class="card-body">
                    <?php $__empty_1 = true; $__currentLoopData = $recentActivities->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="activity-item">
                            <span class="activity-icon activity-<?php echo e($activity['color']); ?>">
                                <i class="bi <?php echo e($activity['icon']); ?>"></i>
                            </span>
                            <div>
                                <div class="fw-semibold" style="font-size: 13px;"><?php echo e($activity['title']); ?></div>
                                <div class="text-muted" style="font-size: 13px;"><?php echo e($activity['description']); ?></div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        const chartBerita = <?php echo json_encode($chartBerita, 15, 512) ?>;
        const chartGaleri = <?php echo json_encode($chartGaleri, 15, 512) ?>;
        const chartUsers = <?php echo json_encode($chartUsers, 15, 512) ?>;
        ...
        if (pieCtx) {
            new Chart(pieCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        data: [<?php echo e($totalBeritas); ?>, <?php echo e($totalGaleris); ?>, <?php echo e($totalGuruStaff); ?>, <?php echo e($totalPrograms); ?>, <?php echo e($totalPpdbItems); ?>],
