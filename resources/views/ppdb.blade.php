        ...
        <div class="max-w-6xl mx-auto px-8 sm:px-12 lg:px-16">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                ...
                <div class="bg-indigo-50 border border-indigo-100 rounded-2xl p-6 text-center">
                    ...
                    <p class="text-indigo-700 font-semibold text-sm">{{ \App\Models\Setting::get('ppdb_lokasi', 'Ruang Tata Usaha') }}</p>
                    ...
                    <div class="relative">
                        ...
                        <div class="space-y-5">
                            ...
                            <div class="flex gap-4 relative">
                                <div class="w-10 h-10 bg-indigo-600 text-white rounded-full flex items-center justify-center font-bold text-sm shrink-0 z-10 shadow">{{ $i + 1 }}</div>
                                <div class="pt-1.5">
            ...
            <div class="bg-white rounded-3xl shadow-sm border border-blue-100 p-8 md:p-12 flex flex-col md:flex-row items-center gap-8">
                <div class="flex-1">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3">
                        <a href="tel:{{ \App\Models\Setting::get('sekolah_telepon', '(0291) 771380') }}" class="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-3 rounded-xl transition-all duration-200 shadow-sm">
