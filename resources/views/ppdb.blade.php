...
@section('title', 'PPDB 2026 - SD Negeri 3 Krasak Bangsri')
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-start gap-4 p-4 bg-gray-50 rounded-xl border border-gray-100">
                            <div class="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center shrink-0">
                                <i class="bi {{ $item['icon'] }} text-blue-600"></i>
                            </div>
                            <div>
                    ...
                    <div class="relative">
                        ...
                        <div class="space-y-5">
                            ...
                            <div class="flex gap-4 relative">
                                <div class="w-10 h-10 bg-indigo-600 text-white rounded-full flex items-center justify-center font-bold text-sm shrink-0 z-10 shadow">{{ $a['step'] }}</div>
                                <div class="pt-1.5">
                                    <p class="font-semibold text-gray-900 text-sm">{{ $a['title'] }}</p>
                                    <p class="text-gray-500 text-xs mt-0.5">{{ $a['desc'] }}</p>
                                </div>
                            </div>
                            @endforeach
                        </div>
