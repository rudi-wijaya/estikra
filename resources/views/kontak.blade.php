    ...
    <section class="py-12 bg-white">
        <div class="max-w-5xl mx-auto px-6 sm:px-8 lg:px-10">
            ...
            <div class="bg-gradient-to-br from-blue-700 to-blue-900 rounded-xl p-10 text-white text-center max-w-2xl mx-auto mb-12 shadow-lg">
                ...
                <a href="https://wa.me/{{ \App\Models\Setting::get('sekolah_whatsapp', '6281234567890') }}" target="_blank" class="inline-flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white font-bold px-8 py-3 rounded-lg transition-colors duration-300 shadow-md hover:shadow-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
                ...
                <div class="border border-gray-200 rounded-lg p-6 hover:border-blue-300 transition-colors">
                    ...
                    <p class="text-sm text-gray-600 leading-relaxed">
                        <strong class="text-gray-900">{{ \App\Models\Setting::get('sekolah_telepon', '(0291) 771380') }}</strong><br>
                ...
                <div class="border border-gray-200 rounded-lg p-6 hover:border-blue-300 transition-colors">
                    ...
                    <p class="text-sm text-gray-600 leading-relaxed">
                        <a href="mailto:{{ \App\Models\Setting::get('sekolah_email', 'sdn3krasakbangsri@gmail.com') }}" class="text-blue-600 hover:text-blue-700 font-medium">
