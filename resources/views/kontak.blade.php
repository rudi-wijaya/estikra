    ...
    <section class="py-12 bg-white">
        <div class="max-w-5xl mx-auto px-6 sm:px-8 lg:px-10">
            ...
            <div class="bg-gradient-to-br from-blue-700 to-blue-900 rounded-xl p-10 text-white text-center max-w-2xl mx-auto mb-12 shadow-lg">
                ...
                <a href="{{ \App\Models\Setting::get('sekolah_instagram', 'https://www.instagram.com/sdn3krasakbangsri') }}" target="_blank" class="inline-flex items-center gap-2 bg-white/20 hover:bg-white/30 text-white font-bold px-8 py-3 rounded-full transition-colors duration-300 shadow-md hover:shadow-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
                ...
                <div class="border border-gray-200 rounded-lg p-6 hover:border-blue-300 transition-colors">
                    ...
                    <p class="text-sm text-gray-600 leading-relaxed">
                        {{ \App\Models\Setting::get('sekolah_alamat', 'Jl. Raya Krasak No. 45, Desa Krasak, Kec. Bangsri, Kabupaten Jepara, Jawa Tengah 59453') }}
                    </p>
                </div>
                ...
                @if ($phoneNumber !== '')
                    <div class="border border-gray-200 rounded-lg p-6 hover:border-blue-300 transition-colors">
                        ...
                        <p class="text-sm text-gray-600 leading-relaxed">
                            <a href="tel:{{ $phoneNumber }}" class="text-blue-600 hover:text-blue-700 font-semibold">
                                {{ $phoneNumber }}
                            </a><br>
                ...
                @if ($whatsappNumberOnlyDigits !== '')
                    <div class="border border-gray-200 rounded-lg p-6 hover:border-green-300 transition-colors">
                        ...
                        <p class="text-sm text-gray-600 leading-relaxed mb-4">
                            <a href="https://wa.me/{{ $whatsappNumberOnlyDigits }}" target="_blank" rel="noopener" class="text-green-600 hover:text-green-700 font-semibold">
                                {{ $whatsappNumber }}
                            </a><br>
                            <span class="text-xs text-gray-500">Chat WhatsApp Sekolah</span>
                        </p>
                        <a href="https://wa.me/{{ $whatsappNumberOnlyDigits }}" target="_blank" rel="noopener" class="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white text-sm font-semibold px-4 py-2 rounded-full transition-colors duration-300">
                ...
                <div class="border border-gray-200 rounded-lg p-6 hover:border-blue-300 transition-colors">
                    ...
                    <p class="text-sm text-gray-600 leading-relaxed">
                        <a href="mailto:{{ \App\Models\Setting::get('sekolah_email', 'sdn3krasakbangsri@gmail.com') }}" class="text-blue-600 hover:text-blue-700 font-medium break-all">
                            {{ \App\Models\Setting::get('sekolah_email', 'sdn3krasakbangsri@gmail.com') }}
                        </a>
                    </p>
                </div>
            </div>
