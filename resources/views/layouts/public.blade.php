    ...
    <footer class="bg-gray-900 text-gray-300 pt-12 pb-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-center text-xs text-gray-500 gap-3 pt-6">
                <p>&copy; {{ date('Y') }} {{ \App\Models\Setting::get('sekolah_nama', 'SD Negeri 3 Krasak Bangsri') }}, All Right Reserved. dikembangkan oleh <a href="https://www.instagram.com/deekund?igsh=YW5qOThzN25oYW11" target="_blank" rel="noopener noreferrer" class="text-blue-400 hover:text-blue-300 transition-colors duration-300 underline">M. Rudi Wijaya</a></p>
            </div>
        </div>
    </footer>
