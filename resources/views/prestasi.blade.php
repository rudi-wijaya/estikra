            ...
            @if ($prestasis->hasPages())
                <div class="flex justify-center mt-10">
                    <nav class="flex items-center gap-2" aria-label="Pagination">
                        ...
                        @else
                            <a href="{{ $prestasis->previousPageUrl() }}" class="inline-flex items-center rounded-full px-4 py-2 text-sm font-semibold text-blue-700 bg-blue-50 hover:bg-blue-100 transition-colors">Sebelumnya</a>
                        @endif
                        ...
                        @if ($prestasis->hasMorePages())
                            <a href="{{ $prestasis->nextPageUrl() }}" class="inline-flex items-center rounded-full px-4 py-2 text-sm font-semibold text-blue-700 bg-blue-50 hover:bg-blue-100 transition-colors">Berikutnya</a>
                        @else
