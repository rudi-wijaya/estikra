                    ...
                    >
                        <div class="h-44 bg-gradient-to-br from-blue-100 to-blue-200 overflow-hidden">
                            @if ($program->foto)
                                ...
                                @endphp
                                <img src="{{ $programFoto }}" alt="{{ $program->judul }}" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300">
                            @else
    ...
    <section class="py-8 bg-gradient-to-r from-blue-600 to-blue-700">
        <div class="max-w-4xl mx-auto px-6 sm:px-8 lg:px-10 text-center">
            ...
            <div class="flex flex-wrap items-center justify-center gap-4">
                <a href="{{ \App\Models\Setting::get('sekolah_instagram', 'https://www.instagram.com/sdn3krasakbangsri') }}" target="_blank" rel="noopener noreferrer"
